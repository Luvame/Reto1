...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Conversor Moneda'),
    );
  }
}
...
List<calculadora> cal = <calculadora>[
  calculadora("9", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("8", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("7", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("6", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("5", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("4", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("3", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("2", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("1", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("0", Color.fromARGB(255, 51, 148, 197), Icon(Icons.abc)),
  calculadora("reset", Color.fromARGB(255, 51, 148, 197),
      Icon(Icons.cleaning_services)),
  calculadora(
      "Calcular", Color.fromARGB(255, 51, 148, 197), Icon(Icons.view_stream)),
];
